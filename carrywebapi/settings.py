"""
Django settings for carrywebapi project.
...
SECRET_KEY = '%r68j6c#jkgqlgfyxrvoo1-we7v_1ww$u_8lo8*vms(jdl4^+4'
...
WSGI_APPLICATION = 'carrywebapi.wsgi.application'
